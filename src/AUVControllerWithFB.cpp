/*                                                                                                                                                
 * Filename: AUVControllerWithFB.cpp
 * Path: auv_controller
...
#include "auv_controller/AUVControllerWithFB.h"

namespace auv_controller{
/**
 * @brief Control solution
 */
void AUVControllerWithFB::controllerRun(const AUVKineticSensor& sensor, const AUVControllerInput& input, AUVControllerOutput& output, const double dt)
{
