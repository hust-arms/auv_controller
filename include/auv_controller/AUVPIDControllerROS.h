/*
 * Filename: auv_controller/AUVPIDControllerROS.h
 * Path: auv_controller
 * Created Date: Saturday, Faburary 27th 2021, 10:58:05 am
 * Author: zhao wang
 * 
 * Copyright (c) 2021 hust-arms
 */
#ifndef AUV_PID_CONTROLLER_ROS_H_
#define AUV_PID_CONTROLLER_ROS_H_
...
typedef boost::shared_ptr<AUVPIDController> AUVPIDControllerPtr;

/**
 * @brief AUV controller ROS wrapper class
 */
class AUVPIDControllerROS{
public:
    /**
     * @brief Default constructor
     */ 
    AUVPIDControllerROS(std::string name, bool with_ff, bool x_type, bool debug);
